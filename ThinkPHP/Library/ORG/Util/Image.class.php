...
class Image {
    ...
    function showImg($imgFile, $text='', $x='50', $y='50', $alpha='50') {
        //获取图像文件信息
            ...
            if ($im) {
                ...
                if (!empty($text)) {
                    ...
                    if (is_file($text) && file_exists($text)) {//判断$text是否是图片路径
						...
						*/
						$font_size = 18;
						$font_path = dirname(__FILE__)."/font/fzhtjw.TTF";
						$tc = imagecolorallocate($im, 198, 209, 231);
						imagettftext($im, $font_size, 0, $x, $y, $tc, $font_path, $text); 
                    }
                    //ImageDestroy($tc);
                }
