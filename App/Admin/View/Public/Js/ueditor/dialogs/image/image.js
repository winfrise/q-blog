    ...
    RemoteImage.prototype = {
        ...
        initEvents: function () {
            ...
            domUtils.on($G("width"), 'keyup', function(){
				var _src=$G("url").value;
				var img=UE.dom.domUtils.createElement( document, 'img', {
					 src: _src
				 } );
				var proportion=parseInt(img.width) /parseInt(img.height);                
			...
			domUtils.on($G("refresh"), 'click', function(){
				var _src=$G("url").value;
				var img=UE.dom.domUtils.createElement( document, 'img', {
					 src: _src
				 } );
